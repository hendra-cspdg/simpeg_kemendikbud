        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>assets/images/<?php echo (isset($current_user->PHOTO) && $current_user->PHOTO != "") ? $current_user->PHOTO : 'noimage.jpg'; ?>" class="user-image" alt="Photo Profile">
