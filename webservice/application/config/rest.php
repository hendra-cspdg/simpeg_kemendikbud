...
|
*/
$config['auth_library_class'] = 'Rest_Authenticator';
...
|
*/
//$config['auth_override_class_method']['example']['users'] = 'basic';
// $config['auth_override_class_method']['deals']['view'] = 'none';
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
...
|
*/
$config['rest_keys_table'] = 'webservice.api_keys';
...
|
*/
$config['rest_logs_table'] = 'webservice.api_logs';
...
|
*/
$config['rest_access_table'] = 'webservice.api_access';
...
|
*/
$config['rest_limits_table'] = 'webservice.api_limits';
