...
<div class="tab-pane" id="<?php echo $TAB_ID;?>">
    <div class="form-group">
        <div class="row">
            ...
            <?php if ($this->auth->has_permission('riwayatpekerjaan.Kepegawaian.Create')) : ?>
            <a type="button" class="show-modal-custom btn btn-default btn-warning margin pull-right " href="<?php echo base_url(); ?>pegawai/riwayatpekerjaan/add/<?php echo $PNS_ID ?>" tooltip="Tambah Riwayat Pekerjaan">
...
<script type="text/javascript">
	(function($){
		...
		var grid_daftar = $(".table-datatable",$container).DataTable({
				...
				ajax: {
					url: "<?php echo base_url() ?>pegawai/riwayatpekerjaan/ajax_list",
					type:'POST',
					data : {
		...
		$container.on('click','.show-modal-custom',function(event){
			showModalX.call(this,'sukses-tambah-riwayat-pekerjaan',function(){
			...
			var kode =$(this).attr("kode");
				...
				function (isConfirm) {
					if (isConfirm) {
						...
						$.ajax({
								url: "<?php echo base_url() ?>pegawai/riwayatpekerjaan/delete/"+kode,
								dataType: "html",
								timeout:180000,
