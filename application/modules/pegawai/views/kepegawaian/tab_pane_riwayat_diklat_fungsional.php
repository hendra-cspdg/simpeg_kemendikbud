...
<script type="text/javascript">
	...
	(function($){
		...
		$container.on('click','.show-modal-custom',function(event){
			showModalX.call(this,'sukses-tambah-riwayat-diklat-fungsional',function(){
				grid_daftar.ajax.reload();
			},this);
		...
		$container.on('click','.btn-hapus',function(event){
			...
			var kode =$(this).attr("kode");
				swal({
					title: "Anda Yakin?",
					text: "Hapus data Riwayat Diklat Fungsional!",
					type: "warning",
				...
				function (isConfirm) {
					if (isConfirm) {
						...
						$.ajax({
								url: "<?php echo base_url() ?>pegawai/diklatfungsional/delete/"+kode,
								dataType: "html",
								timeout:180000,
