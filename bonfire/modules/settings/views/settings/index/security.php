<fieldset>
    ...
    <div class="control-group<?php echo form_error('allow_register') ? $errorClass : ''; ?> col-sm-12">
        <div class="controls">
    ...
    <div class="control-group<?php echo form_error('login_type') ? $errorClass : ''; ?> col-sm-12">
    ...
    <div class="control-group<?php echo form_error('remember_length') ? $errorClass : ''; ?> col-sm-12" id="remember-length"<?php echo $settings['auth.allow_remember'] ? '' : ' style="display:none"'; ?>>
    ...
    <div class="control-group<?php echo form_error('password_min_length') ? $errorClass : ''; ?> col-sm-12" id="password-strength">
    ...
    <div class="control-group<?php echo form_error('password_iterations') ? $errorClass : ''; ?> col-sm-12">
